// AGENT 5 — ALL ARTIFACT SCHEMAS  [CHANGE-MANAGEMENT REPLICA]
// ─── Managed copy — production source: public/prompts/agent5/A1-FlattenedArtifactSchema.js
//     The /api/inject-artifact endpoint updates the "Allowed types" line in THIS file.
//     It never touches the production source.
// Contains artifact contract intro + all artifact type schemas.
...
LAYOUT MODE **” detecting if the layout has a header area:
  ...
  - ph_count â‰¤ 2: layout has only title + body placeholders, no dedicated header
    ...
    â†’ style is always “underline” (see ARTIFACT HEADER RULES)
